...
public class ObjectFactory {
    ...
    private final static QName _BookCreateException_QNAME = new QName("http://service.wslab.lavlad.org/", "BookCreateException");
    private final static QName _DeleteBookById_QNAME = new QName("http://service.wslab.lavlad.org/", "deleteBookById");
    private final static QName _BookUpdateException_QNAME = new QName("http://service.wslab.lavlad.org/", "BookUpdateException");
    ...
    private final static QName _BookSearchException_QNAME = new QName("http://service.wslab.lavlad.org/", "BookSearchException");
    private final static QName _BookNotFoundException_QNAME = new QName("http://service.wslab.lavlad.org/", "BookNotFoundException");
    ...
    /**
     * Create an instance of {@link BookCreateFault }
     * 
     */
    public BookCreateFault createBookCreateFault() {
        return new BookCreateFault();
    }
    ...
    /**
     * Create an instance of {@link BookUpdateFault }
     * 
     */
    public BookUpdateFault createBookUpdateFault() {
        return new BookUpdateFault();
    }
    ...
    /**
     * Create an instance of {@link BookNotFoundFault }
     * 
     */
    public BookNotFoundFault createBookNotFoundFault() {
        return new BookNotFoundFault();
    }
    ...
    /**
     * Create an instance of {@link BookSearchFault }
     * 
     */
    public BookSearchFault createBookSearchFault() {
        return new BookSearchFault();
    }
    ...
    /**
     * Create an instance of {@link BookSearchTO }
     * 
     */
    public BookSearchTO createBookSearchTO() {
        return new BookSearchTO();
    }

    /**
     * Create an instance of {@link BookUpdateTO }
     * 
     */
    public BookUpdateTO createBookUpdateTO() {
        return new BookUpdateTO();
    }

    /**
     * Create an instance of {@link BookCreateTO }
     * 
     */
    public BookCreateTO createBookCreateTO() {
        return new BookCreateTO();
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link BookCreateFault }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service.wslab.lavlad.org/", name = "BookCreateException")
    public JAXBElement<BookCreateFault> createBookCreateException(BookCreateFault value) {
        return new JAXBElement<BookCreateFault>(_BookCreateException_QNAME, BookCreateFault.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link BookUpdateFault }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service.wslab.lavlad.org/", name = "BookUpdateException")
    public JAXBElement<BookUpdateFault> createBookUpdateException(BookUpdateFault value) {
        return new JAXBElement<BookUpdateFault>(_BookUpdateException_QNAME, BookUpdateFault.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link BookSearchFault }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service.wslab.lavlad.org/", name = "BookSearchException")
    public JAXBElement<BookSearchFault> createBookSearchException(BookSearchFault value) {
        return new JAXBElement<BookSearchFault>(_BookSearchException_QNAME, BookSearchFault.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link BookNotFoundFault }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service.wslab.lavlad.org/", name = "BookNotFoundException")
    public JAXBElement<BookNotFoundFault> createBookNotFoundException(BookNotFoundFault value) {
        return new JAXBElement<BookNotFoundFault>(_BookNotFoundException_QNAME, BookNotFoundFault.class, null, value);
    }
